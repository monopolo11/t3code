...
import {
  makeDispatchBootstrapTurnStart,
  toDispatchCommandError,
} from "./orchestration/BootstrapTurnStart.ts";
...
const makeWsRpcLayer = (
  ...
  WsRpcGroup.toLayer(
    Effect.gen(function* () {
      ...
      const dispatchBootstrapTurnStart = yield* makeDispatchBootstrapTurnStart(dispatchFromClient);
