...
export const toDispatchCommandError = (cause: unknown, fallbackMessage: string) =>
...
/** Share first-turn setup and failure cleanup across WebSocket and local HTTP clients. */
export const makeDispatchBootstrapTurnStart = Effect.fn("makeDispatchBootstrapTurnStart")(
  function* (dispatchFromClient: OrchestrationEngineShape["dispatch"]) {
